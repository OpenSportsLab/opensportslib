...
_EXPORTS = {
    ...
    "MissingDatasetInputsError": ("opensportslib.tools.hf_transfer", "MissingDatasetInputsError"),
    ...
    "HF_FORMAT_KEY": ("opensportslib.tools.hf_transfer", "HF_FORMAT_KEY"),
    "HF_COMMIT_KEY": ("opensportslib.tools.hf_transfer", "HF_COMMIT_KEY"),
    ...
    "find_missing_dataset_inputs": ("opensportslib.tools.hf_transfer", "find_missing_dataset_inputs"),
