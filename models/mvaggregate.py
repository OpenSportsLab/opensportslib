from utils.mv_batch_tensor import batch_tensor, unbatch_tensor
import torch
...
class MVAggregate(nn.Module):
    def __init__(self, model, num_classes=8, agr_type="max", feat_dim=400, lifting_net=nn.Sequential()):
        super().__init__()
